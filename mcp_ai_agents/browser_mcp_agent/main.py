...
with st.sidebar:
    ...
    st.markdown("- Go to github.com/Shristyverse/shristyverse-llm-suite")
    ...
    st.markdown("- Navigate to github.com/Shristyverse/shristyverse-llm-suite, scroll down, and report details")
