...
with col1:
    repo = st.text_input("Repository", value="Shristyverse/shristyverse-llm-suite", help="Format: owner/repo")
with col2:
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., Shristyverse/shristyverse-llm-suite)</li>
