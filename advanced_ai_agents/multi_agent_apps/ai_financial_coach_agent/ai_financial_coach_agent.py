...
2024-01-03,Transportation,45.00"""
    ...
    with about_tab:
        ...
        - Check the [documentation](https://github.com/Shristyverse/shristyverse-llm-suite)
        - Report issues on [GitHub](https://github.com/Shristyverse/shristyverse-llm-suite/issues)
        """)
