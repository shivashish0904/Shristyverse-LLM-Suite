...
```bash
git clone https://github.com/Shristyverse/shristyverse-llm-suite.git
cd shristyverse-llm-suite/chat_with_X_tutorials/chat_with_pdf
```
...
https://github.com/Shristyverse/shristyverse-llm-suite/assets/31396011/12bdfc11-c877-4fc7-9e70-63f21d2eb977
